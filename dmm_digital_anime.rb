...
urls = []
urls.push("http://www.dmm.co.jp/digital/anime/-/list/=/sort=date/")
#urls.push("http://www.dmm.com/mono/dvd/-/list/=/article=keyword/id=6014/page=50/")

for num in 1..10 do
  url = "http://www.dmm.co.jp/digital/anime/-/list/=/sort=date/page=" + num.to_s + "/"
  #puts url
  urls.push(url)
end
...
Anemone.crawl(urls, opts) do |anemone|
  anemone.on_every_page do |page|
    ...
    items.each do |item|
		#puts item
		site = "http://www.dmm.co.jp/digital/anime/"
		url = ""
		...
		b = ItemsDigitalAnime.exists?(:link => url)
		if b then
			next
		end
