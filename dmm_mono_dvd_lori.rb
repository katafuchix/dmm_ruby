...
urls = []
urls.push("http://www.dmm.co.jp/mono/dvd/-/list/=/article=keyword/id=2008/")
urls.push("http://www.dmm.co.jp/mono/dvd/-/list/=/article=keyword/id=2008/sort=date/");

for num in 1..50 do
  url = "http://www.dmm.co.jp/mono/dvd/-/list/=/article=keyword/id=2008/sort=date/page=" + num.to_s + "/"
  #puts url
  urls.push(url)
end

for num in 1..50 do
  url = "http://www.dmm.co.jp/mono/dvd/-/list/=/article=keyword/id=2008/sort=ranking/page=" + num.to_s + "/"
  #puts url
  urls.push(url)
end

#for num in 1..312 do
#  url = "http://www.dmm.co.jp/mono/dvd/-/list/=/article=keyword/id=2008/page=" + num.to_s + "/"
  #puts url
#  urls.push(url)
#end
...
Anemone.crawl(urls, opts) do |anemone|
  anemone.on_every_page do |page|
    ...
    items.each do |item|
		...
		b = ItemsMonoDvdLori.exists?(:link => url)
		if b then
			next
		end
